  ...
  return (
    <div className="section" style={{ minHeight: 'calc(100vh - 300px)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
      <div className="card" style={{ width: '100%', maxWidth: '450px' }}>
        <h1 style={{ fontSize: '2rem', marginBottom: '2rem', textAlign: 'center' }}>注册</h1>
          ...
          <div className="form-group" style={{ marginBottom: '2rem' }}>
            <div style={{ display: 'flex', alignItems: 'flex-start' }}>
              ...
              <label htmlFor="terms" style={{ fontSize: '0.875rem' }}>
                我已阅读并同意 <Link href="/privacy" style={{ color: 'var(--primary-color)' }}>隐私政策</Link> 和 <Link href="#" style={{ color: 'var(--primary-color)' }}>服务条款</Link>
              </label>
            </div>
          </div>
